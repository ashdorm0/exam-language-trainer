        ...
        ${
          wrongAnswers.length > 0
            ...
            <h3 style="font-family:Arial,sans-serif; font-size:1rem; font-weight:700; margin-bottom:0.75rem;">
                <i class="bi bi-journal-text"></i> Words to review (${
                  wrongAnswers.length
                })
            </h3>
            ${wrongAnswers
              .map(
                ...
                <div class="review-card">
                    ...
                    <div style="font-family:Arial,sans-serif; font-size:0.875rem; color:#991b1b; margin-bottom:0.3rem;">
                        ...
                        Your answer: ${q.options.find(o =>
                          o.startsWith(q.studentAnswer)
                        )}
                    </div>
                    <div class="correct-answer">
                        <i class="bi bi-check-circle-fill"></i>
                        Correct answer: ${q.options.find(o =>
                          o.startsWith(q.correct)
                        )}
                    </div>
                </div>
            `
